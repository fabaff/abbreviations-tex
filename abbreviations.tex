...
\acro{ACE}{ASCII Compatible Encoding}
...
\acro{AMI}{Amazon Machine Images}
\acro{AMQP}{Advanced Message Queuing Protocol}
\acro{ANSI}{American National Standards Institute}
\acro{AP}{Access Point (Wireless-LAN-Zugangspunkt)}
\acro{API}{Application Programmers/Programming Interface}
\acro{APIC}{Advanced Programmable Interrupt Controller}
\acro{APIPA}{Automatic Private IP Addressing}
...
\acro{BER}{Basic Encoding Rules}
\acro{BHG}{Bundesgerichtshof}
...
\acro{BTC}{Bitcoin}
\acro{BV}{Federal Constitution, Bundesverfassung}
...
\acro{DISA}{Defense Information Systems Agency}
...
\acro{EBCDIC}{Extended Binary Coded Decimals Interchange Code}
\acro{ECC}{Error-correcting code}
\acro{EC2}{Amazon Elastic Compute Cloud}
\acro{EDM}{Electronic Document Management}
...
\acro{EPEL}{Extra Packages for Enterprise Linux}
...
\acro{GLBP}{Gateway Load Balancing Protocol}
...
\acro{HASS}{Home Assistant Server Service}
...
\acro{HTML}{Hypertext Markup Language, engl. für Hypertext-Auszeichnungssprache}

%I
\acro{IANA}{Internet Assigned Numbers Authority}
\acro{IASE}{Information Assurance Support Environment}
...
\acro{MD}{Message Digest Algorithm}
...
\acro{MVC}{Model View Controller oder Modell-Präsentation-Steuerung}
...
\acro{NIS-2}{EU-Richtlinien zur Netzwerk- und Informationssicherheit, (engl. Network and Information Security Directive)}
...
%O
\acro{ODM}{Original Design Manufacturer}
...
\acro{OR}{Code of Obligations, Obligationenrecht}
\acro{OSA}{Open Systems Architecture}
\acro{OSB}{OEM for System Builder}
...
\acro{PID}{Prozesskennung, engl. Process identifier}
...
%R
\acro{RIPEMD}{RACE Integrity Primitives Evaluation Message Digest}
...
\acro{RPM}{RPM Package Manager, früher Red Hat Package Manager}
...
\acro{SCAP}{Security Content Automation Protocol}
...
\acro{SOHO}{Small office/Home}
\acro{SOK}{Schienen-Oberkante}
...
\acro{SSP}{State Synchronization Protocol}
\acro{STAR}{Security Test Audit Report}
\acro{STIG}{Security Technical Implementation Guides}
...
\acro{UTC}{Coordinated Universal Time, koordinierte Weltzeit}
...
\acro{ZGB}{Civil Code, Zivilgesetzbuch}
