...
\acro{CEN}{Europäische Komitee für Normung, franz. Comit\'{e} Europ\'{e}en de Normalisation}
...
\acro{MGCP}{Media Gateway Control Protocol}
...
\acro{WAFS}{Wide Area File Services}
\acro{WAIS}{Wide Area Information Server}
\acro{WAN}{Wide Area Network}
\acro{WAP}{Wireless Access Point / Wireless Application Protocol}
...
\acro{XDM}{X Window Display Manager}
\acro{XDMCP}{X Display Manager Control Protocol}
\acro{XP}{Extreme Programming}
\acro{XUL}{XML User Interface Language}
\acro{XVGA}{Extended Video Graphics Adapter}
